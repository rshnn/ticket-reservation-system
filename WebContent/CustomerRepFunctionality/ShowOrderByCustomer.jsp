...
try{
		...
		String command = "select distinct r.resNo,r.dateReserved,p.flightNumber,r.bookingFee, r.totalFare,r.passengers From Users u JOIN Reservations r ON r.cust_username=u.username Join Purchases p ON r.resNo = p.resNo Where u.username='"+username+"'";
...
<form method="post" action="PrintOrder.jsp">			
		<br>
		<table>
			<tr>
				<td>Enter Order Number</td>
				<td><input type="number" name="resNo" maxlength="11"
					required></td>
			</tr>
		</table>
