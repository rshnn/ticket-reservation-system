...
<body>
	...
	String url = "jdbc:mysql://mydbinstance.cvlvoepmucx7.us-east-2.rds.amazonaws.com:3306/trs";
		...
		%>
			<form method="post" action="EditEmployeeHandler.jsp">			
			...
			<table>
				...
				<tr>
					<td>User Type (Manager or CustomerRep)</td>
					<td><input type="number" name="userType" value=<%=userType%> maxlength="10"
					required></td>
				</tr>
				<tr>
					<td>SSN</td>
					<td><input type="text" name="SSN" value=<%=SSN%> maxlength="45"
					required></td>
				</tr>
				<tr>
					<td>Hourly Rate</td>
					<td><input type="text" name="hourlyRate" value=<%=hourlyRate%> maxlength="45"
					required></td>
				</tr>
