...
try{
		...
		String command = "select sum(bookingFee) sum from  " +
				"(select distinct resNo, bookingFee, concat(airlineID, flightNumber) flight " +
						"from Purchases " +
		...
		while (result.next()) {
			...
			out.println("The flight produced $" +sum+ " in revenue.");
